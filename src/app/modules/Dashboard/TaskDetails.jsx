...
export default function TaskDetails({ task_id }) {
  ...
  const fetchTaskDetails = useCallback(async () => {
    try {
      ...
      setSelectedStatus(res.data.task?.status || "")
    } catch (error) {
  ...
  const handleStatusChange = useCallback(async () => {
    ...
    setUpdating(true)
    try {
      await axios.put(`${API_BASE_URL}/tasks/${task_id}`, { status: selectedStatus }, { withCredentials: true })
  ...
  }, [task, selectedStatus, task_id, router])
          ...
          <div className="flex flex-col md:flex-row gap-6 mb-8">
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row gap-4 mb-6">
                <div className="w-[119px] h-[119px] bg-primary rounded-full flex items-center justify-center text-white font-semibold text-lg flex-shrink-0">
                ...
                <div className="flex-1">
                  <h2 className="text-[30.8px] font-poppins leading-[40.656px] font-semibold text-[#161616] mb-[7.7px]">
                    {task.name}
                  </h2>
                  <p className="text-[#667085] font-poppins text-[17.96px] leading-[29.465px]">{task.description}</p>
                  <div className="flex gap-8 mt-[61.3px] mb-[61.66px]">
                    <div className="border-r border-[#E1E1E1] pr-10">
                      ...
                      <div className="flex items-center gap-3 text-gray-900">
                        ...
                        <span className="font-poppins text-[20.615px] text-heading leading-[33.809px]">
                    ...
                    <Badge
                      variant="outline"
                      className={`${getStatusColor(task.status)} text-[32.88px] font-medium border-0 bg-transparent`}
                    >
                      <span
                        className={`${getStatusColor(task.status)} h-[13.812px] w-[13.812px] rounded-full mr-[14px]`}
                      ></span>
                      {task.status}
                    </Badge>
                  </div>
      ...
      <Dialog open={showDeleteModal} onOpenChange={setShowDeleteModal}>
        ...
        <DialogContent className="fixed left-[50%] top-[50%] z-[101] w-full max-w-[425px] translate-x-[-50%] translate-y-[-50%] rounded-lg p-6 bg-white shadow-lg">
          <div className="flex flex-col items-center text-center">
            <Image src="/delete.png" width={350} height={250} />
