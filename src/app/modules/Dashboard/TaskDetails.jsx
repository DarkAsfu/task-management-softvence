...
const getStatusColor = status => {
  switch (status) {
    case 'Pending':
      return 'bg-purple-700 text-[32.228px] text-purple-700 border-purple-200'
    case 'In Progress':
      return 'bg-orange-700 text-[32.228px] text-orange-700 border-orange-200'
    case 'Done':
      return 'bg-green-700 text-[32.228px] text-green-700 border-green-200'
    default:
      return 'bg-gray-700 text-[32.228px] text-gray-700 border-gray-200'
  }
}
            ...
            <div className='flex-1'>
              <div className='flex flex-col sm:flex-row gap-4 mb-6'>
                ...
                <div className='flex-1'>
                  ...
                  <p className='text-[#667085] font-poppins text-[17.96px] leading-[29.465px]'>
                  ...
                  <div className='flex gap-8 mt-[61.3px] mb-[61.66px]'>
                    ...
                    >
                      <span
                        className={`${getStatusColor(
                          'Pending'
                        )} h-[13.812px] w-[13.812px] rounded-full mr-[14px]`}
                      ></span>
                      {'Pending'}
                    </Badge>
                  </div>
